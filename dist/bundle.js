...
*/ var r =
        ...
        function a() {
            return l.a.createElement(
                ...
                l.a.createElement(
                    "h1",
                    null,
                    "Currenty in progress. Check back later!"
                ),
                l.a.createElement(
                    "a",
                    {
                        href:
                            "https://github.com/sharmavins23/sharmavins23.github.io/",
                    },
                    l.a.createElement(
                        "h3",
                        null,
                        "Check out the status of this project."
                    )
                )
            );
        }
    ...
    function (e, t, n) {
        ...
        function $l(e) {
            return (
                null === Fl ? ((Fl = [e]), (Dl = xl(_l, Hl))) : Fl.push(e), Ml
            );
        }
        function Bl() {
            if (null !== Dl) {
        ...
        function Hl() {
            if (!Ll && null !== Fl) {
                ...
                try {
                    ...
                    throw (
                        (null !== Fl && (Fl = Fl.slice(e + 1)), xl(_l, Bl), t)
                    );
                } finally {
                    Ll = !1;
                }
